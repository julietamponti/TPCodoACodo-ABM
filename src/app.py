...
# app.config['MYSQL_DATABASE_USER']='sql10503406'
# app.config['MYSQL_DATABASE_PASSWORD']= 'j1IPgUrkE2'
...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://root:311099@localhost/flaskmysql'
